{@type:sensor}
input: Length1(30, "落底天數");
input: Size1(2000, "量縮張數");
input: Length2(20, "籌碼沉澱天數");
input: Size2(1000, "籌碼清洗張數");
input: Ratio(10, "融資使用率%");
input: Percent(3, "今日漲幅%");
input: Type(1, "融資資料：0=今日 1=昨日");
input: TXT1("僅適用日線", "使用限制");
input: TXT2("盤中無當日融資資料", "建議使用單次洗價模式");
