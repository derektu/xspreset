...
//=========計算RSI======================
Input:rsilength(6, "設定RSI計算天期");
input:rsilimit(50, "設定RSI要突破的限制");

Value1=rsi(close,rsilength);//計算RSI的值

//==========計算威廉指標==================
input: rLength(3, "設定威廉指標天期");
input: rLimit(-50, "設定威廉指標的限制");

value2 = PercentR(rLength) - 100;

//============計算DMI=======================
input: dmiLength(10, "設定DMI天期");
